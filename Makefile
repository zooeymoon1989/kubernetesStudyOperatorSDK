...
# osuk8s.site/visitors-helm-operator-bundle:$VERSION and osuk8s.site/visitors-helm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= osuk8s.site/visitors-helm-operator
